...
diag 'package.json';
is $asset->_render_to_file($t->app, 'package.json', $base->child('package.json')), 'generated',
  'generated package.json';
is $asset->_render_to_file($t->app, 'package.json', $base->child('package.json')), 'custom', 'custom package.json';

diag 'webpack.config.js';
is $asset->_render_to_file($t->app, 'webpack.config.js', $base->child('webpack.config.js')), 'generated',
  'generated webpack.config.js';
is $asset->_render_to_file($t->app, 'webpack.config.js', $base->child('webpack.config.js')), 'current',
...
$base->child('webpack.config.js')->spurt($config);
is $asset->_render_to_file($t->app, 'webpack.config.js', $base->child('webpack.config.js')), 'custom',
  'custom webpack.config.js';

diag 'webpack.custom.js';
$asset->_render_to_file($t->app, 'webpack.custom.js', $base->child('webpack.custom.js'));
